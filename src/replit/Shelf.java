...
public class Shelf {
    ...
    public static void main(String[] args) {
        addBook(700,"dilmurod","java",100);
        addBook(701,"dil","cava",102);



        System.out.println(theBooks);
        System.out.println(isShelfEmpty());
        System.out.println(isIDUnique(300));
        Book b1 = new Book(703,"dilmurod","saqa",200);
        System.out.println(addBook(b1));
        System.out.println(theBooks);
        System.out.println(getTitleByID(703));
        System.out.println(getAllBooksForAuthor("dilmurod"));
        System.out.println(findBookByPartialTitle("ava"));
        System.out.println(theBooks);
        removeBook(700);
        System.out.println(theBooks);
            addBook(312,"dil","red",21);
        System.out.println(theBooks);
        removeBook("dil");
        System.out.println(theBooks);
