...
public class Book {
    ...
    public static String capitalize(String word) {
        ...
        if(word.contains(" ")){
            ...
            for (int i = 0; i <splitted.length ; i++) {
                ...
                result+= splitted[i].substring(0,1).toUpperCase()+splitted[i].substring(1).toLowerCase()+" ";
                }
    ...
    public static Boolean isTitleWord(String word) {
        String[] badWords = {"a","an","the","and","but","for","nor","or","so","yet","at","by","in","into",
        ...
        if(!title.contains(" ")){
            ...
            for (int i = 0; i <splitted.length ; i++) {
                if(isTitleWord(splitted[i])){
                    String capitalized = capitalize(splitted[i]);
                    result+=capitalized+" ";
                }else{
