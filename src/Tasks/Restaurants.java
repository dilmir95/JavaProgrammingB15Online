...
public class Restaurants {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of restaruant: "+ restaurants.length);
        ...
        for (String eachRestaruant: restaurants){
            System.out.println(eachRestaruant);
        }

        //TASK 3. count how many "McDonald's" in array
        int mcdonalsCount = 0;
        for(String eachMcDonalds: restaurants){
            if(eachMcDonalds.contains("McDonald's")){
                ++mcdonalsCount;
            }
        }
        ...
        for(String multipleRes : restaurants){
            if(multipleRes.contains("Popeye's Chicken")){
                ++popeyesCount;
            }else if(multipleRes.contains("Domino's Pizza")){
                ++dominosCount;
            }else if(multipleRes.contains("Taco Bell")){
                ++tacoBellCount;
            }
        }
        //System.out.println(popeyesCount+" "+ dominosCount+" "+ tacoBellCount);
         ...
         */
        System.out.println("=================================================");
        for(String txMc: restaurants){
            if(txMc.contains("McDonald's") && txMc.contains("TX")){
                System.out.println(txMc);
            }
        }
        ...
        System.out.println("===========================================");
        String firstRes = restaurants[0];
        String[] words= firstRes.split(",");
        System.out.println(Arrays.toString(words));
        System.out.println(words[2]+" -> "+ words[1]+" "+ words[4]);
        System.out.println("=================================================");
        //TASK 7. Print each restaurant name, City, state in above format for all restaurants
        for (int i = 0; i <restaurants.length ; i++) {
          String[] wordArray=  restaurants[i].split(",");
            System.out.println(wordArray[2]+" -> "+wordArray[1]+", "+wordArray[4]    );
        }
    }
}
