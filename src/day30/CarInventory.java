...
public class CarInventory {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <cars.length ; i++) {
          if(cars[i].startsWith("Tesla")){
              String[] eachCarSplitted = cars[i].split("-");
            ...
            int count2Char = 0;
        for (int i = 0; i <cars.length ; i++) {
            String[] eachCarSplittled = cars[i].split("-",2);
//            if(eachCarSplittled.length==3) {
//                continue;
//            }
            if(eachCarSplittled[1].length()==3){
